...
// Facebook administrada por quem autorizou o app.
async function findInstagramAccount(longLivedToken) {
  const pages = await graphGet('/me/accounts', { access_token: longLivedToken, fields: 'id,name,instagram_business_account' });
